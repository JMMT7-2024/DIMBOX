# core/models.py - VERSIÓN REORGANIZADA Y LIMPIA
...
class User(AbstractUser):
    ...
    def effective_limits(self):
        """
        ✅ Devuelve los límites efectivos (personalizados o por defecto del plan)
        """
    ...
    def usage_stats(self):
        """
        ✅ Calcula estadísticas de uso actual
        """
    ...
    def has_reached_limit(self, limit_type, current_count=None):
        """
        ✅ Verifica si se ha alcanzado un límite específico
        """
    ...
    def save(self, *args, **kwargs):
        """
        ✅ Auto-calcular record_count solo después de tener primary key
        """
...
class Transaction(models.Model):
    ...
    def clean(self):
        """
        ✅ Validación de límites antes de guardar
        """
    ...
    def save(self, *args, **kwargs):
        """
        ✅ Incluir validación de límites al guardar
        """
        self.clean()
        super().save(*args, **kwargs)
